        ...
        if(deplacementBlanc != ""){
            ...
            if(descBlanc[0] != "Pion"){
                ...
                for(Piece* p : getListePiece()){
                    if(p->getCouleur() == "Blanc" && p->getNomString() == typePiece && ((descBlanc[1] == "" || p->getPosition().getColonne() == descBlanc[1]) && (descBlanc[2] == "" || p->getPosition().getLigne() == descBlanc[2]))){
                        ...
                        for(Position pos : p->getListeCoupsPossibles()){
                            ...
                            if(pos.getCoord() == deplacement){
                                ...
                                if(nbCoup == 1){
                                    ...
                                    Position pos = p->getPosition(); // On stock la position initiale de la pièce
            ...
            // C'est donc forcément un pion blanc
                for(Piece *p : getListePiece()){
                    if(p->getCouleur() == "Blanc" && p->getNomString() == "Pion" && (descBlanc[1] == "" || p->getPosition().getColonne() == descBlanc[1])){
            ...
            */
            ...
            if(typePiece != "Pion"){
                ...
                for(Piece* p : getListePiece()){
                    ...
                    if(p->getCouleur() == "Noir" && p->getNomString() == typePiece && ((descNoir[1] == "" || p->getPosition().getColonne() == descNoir[1]) && (descNoir[2] == "" || p->getPosition().getLigne() == descNoir[2]))){
            ...
            // C'est donc forcément un pion noir
                ...
                for(Piece* p : getListePiece()){
                    if(p->getCouleur() == "Noir" && p->getNomString() == "Pion" && (descNoir[1] == "" || p->getPosition().getColonne() == descNoir[1])){
